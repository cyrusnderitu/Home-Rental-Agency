  ...
  return (
    <div className='mt-10'>
      ...
      <div className="intro_cont flex mb-10">
        ...
        <div className="right flex-1 mt-20">
          <div className="intro_data grid grid-cols-3 gap-y-10">
            ...
            <div className="intro_show">
              ...
              <h2 className="font-inter font-bold text-[20px] leading-[35px] capitalize">Stay safe! save money</h2>
            </div>
            <div className="intro_show">
              <a className="p-[8px] shadow-lg rounded-lg mb-1 flex justify-center item-center w-fit"> 
                <RiEye2Line className='text-[#F4511E] text-3xl'/>
              </a>
              <h2 className="font-inter font-bold text-[20px] leading-[35px] capitalize">pay for what you use!</h2>
            </div>
          </div>
