...
const PropCard = ({ data }) => {
  return (
    <div className="blog-post shadow-lg rounded-lg" key={data.id}>
      <img className="cover-img skeleton rounded-t-lg" src={`${data.coverImage} ? ${data?.coverImage}: 'https://www.shutterstock.com/image-vector/motion-designer-working-on-computer-260nw-2135985137.jpg'`} alt="cover-imge" />
